      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          <div className="space-y-4">
            ...
            <p className="text-primary-foreground/80 leading-relaxed text-sm">
              Providing accessible, high-quality online Quran education globally
              with certified male and female teachers.
            </p>
          </div>
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-primary-foreground/80 hover:text-accent transition-colors text-sm flex items-center gap-2"
                  >
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                ...
                <li
                  key={course}
                  className="text-primary-foreground/80 text-sm flex items-center gap-2"
                >
                  <span className="w-1.5 h-1.5 rounded-full bg-accent/50"></span>
                  {course}
                </li>
        ...
        <div className="pt-8 border-t border-primary-foreground/10 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-primary-foreground/60 text-sm">
            &copy; {new Date().getFullYear()} Al-Rehman Islamic Center. All
            rights reserved.
          </p>
